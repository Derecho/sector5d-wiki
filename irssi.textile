...
The following commands will create a basic SSL connection to Sector 5D. For a better setup please see [[the full configuration guide|#Full configuration]] below.
